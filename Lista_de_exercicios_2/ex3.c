...
//3. Apresente um algoritmo para imprimir todos os elementos de uma lista, do último ao primeiro.
...
void printa_lista_rec(TipoLista *lista) {
    if (lista == NULL) {//Caso base: Encerra a função caso a lista esteja vazia ou caso chegar ao fim da lista
        ...
        printa_lista_rec(lista->prox);//Caso recursivo: Irá empilhar a função até seu último nó, e depois printa campo chave por campo chave, ou seja, do último ao primeiro
