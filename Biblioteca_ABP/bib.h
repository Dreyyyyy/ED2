...
void printa_pre_ordem(NoArvBinaria *raiz);//Implementado
 ...
 * por raiz.
 */
NoArvBinaria *buscaArvBinRec(NoArvBinaria *raiz, int k);//Implementado
 ...
 */
NoArvBinaria *buscaAB(NoArvBinaria *raiz, int k);//Implementado
 ...
 * (*x)->chave == k
 */
NoArvBinaria **buscaEnderecoDoPonteiro(NoArvBinaria **raiz, int k);//Implementado
...
NoArvBinaria **buscafolha(NoArvBinaria **raiz);//Implementado

void removeFolha(NoArvBinaria **folha);//Implementado
 ...
 */
NoArvBinaria *insereArvBinRec(NoArvBinaria **raiz, int k);//Implementado
